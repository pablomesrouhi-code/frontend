...
export default function Header() {
  ...
  return (
    <>
      {/* Logo bar only — sticky, no banner JS on scroll */}
      <div className="sticky top-0 z-30 pt-[max(0px,env(safe-area-inset-top))]">
      ...
      {/* Banner under logo — NOT sticky: scrolls away naturally, zero scroll lag */}
      <div
        className="px-4 py-2"
        style={{
