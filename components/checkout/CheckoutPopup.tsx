      ...
      const net =
        err instanceof TypeError
          ? liveStoreHost
            ...
            : ' تعذّر الاتصال بالـ API قبل أن يصل أي ردّ من السيرفر (عنوان خاطئ للـ API في البناء، سيرفر متوقّف، أو مشكلة شبكة). هذا ليس حظرًا تلقائيًا خارج السعودية — الحظر الإقليمي (MaxMind) يظهر بطلب مختلف برمز HTTP 403 من الخادم.'
          : ''
      setCheckoutError(
