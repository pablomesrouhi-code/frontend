  ...
  return (
    <div className="mb-4 grid grid-cols-2 gap-2 sm:mb-5 sm:grid-cols-4 sm:gap-2.5">
      {stats.map((stat) => (
        <div
          key={stat.label}
          className="rounded-xl border border-border/80 bg-white/95 px-2.5 py-2.5 text-center shadow-sm sm:rounded-2xl sm:px-3 sm:py-3"
        >
          <p className="text-base font-black tabular-nums leading-none sm:text-lg" style={{ color: accentColor }}>
            {stat.value}
          </p>
