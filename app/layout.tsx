...
export const metadata: Metadata = {
  ...
  description:
    'نبتة لابو: علكات تحمل تركيبات مكمّل غذائي مرخّص SFDA؛ سلطة وتسمية تشبه نقطة الثقة كما تجدينها أمام الدوّاء — جمال يومي، راحة بعد الأكل، وهدوء مسائي. المملكة العربية السعودية.',
  keywords:
