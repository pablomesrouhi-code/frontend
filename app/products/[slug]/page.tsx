                    ...
                    <p className="mt-2 border-t border-border/80 pt-2 text-sm leading-relaxed text-muted">
                      {
                        ({
                          ...
                          'زنك': 'معدن يدعم وظائف طبيعية مرتبطة بالشعر والبشرة والأظافر ضمن روتين تغذية داخلية منتظم.',
                          'فيتامين D': 'يدعم الصحة العامة وامتصاص الكالسيوم؛ ضمن الفورمولا مع البيوتين والزنك حسب غلاف عبوّتكم.',
                          'فيتامين D3': 'شكل نشط من فيتامين D يدعم الصحة العامة وتوازن الهرمونات مع التغذية المتوازنة.',
                          'بروبيوتيك': 'بكتيريا نافعة تدعم التوازن الطبيعي للجهاز الهضمي وفق منتج هذا التصنيف.',
                          'ألياف': 'تدعم حركة الهضم الطبيعية وإحساس الخفة بعد الوجبات ضمن نمط غذائي متوازن.',
                          'مغنيسيوم': 'معدن يدعم مسارات الاسترخاء والجهاز العصبي مع تناول مناسب حسب تعليمات العبوة المعتمدة.',
                          'L-Theanine': 'من مصادر طبيعية معروفة؛ يُستخدم في سياق دعم الاسترخاء ضمن المنتج كمكمّل غذائي.',
                          'كولاجين بحري': 'بروتين مستخلص من السمك يدعم بنية الشعر والبشرة والمفاصل من الداخل — يُذاب في ماء أو عصير.',
                          'حديد': 'معدن أساسي ترتبط قلّته بتساقط الشعر عند النساء — يدعم نقل الأكسجين والتغذية لبصيلات الشعر.',
                          'فيتامين C': 'مضاد أكسدة يدعم بناء الكولاجين وامتصاص الحديد وإشراق البشرة ضمن تركيبة متكاملة.',
                          'حمض الفوليك': 'فيتامين B9 ضروري لتجديد الخلايا وصحة بصيلات الشعر؛ يُدعم مع بقية مكوّنات التركيبة.',
                          'غلوتاثيون': 'مضاد أكسدة قوي مرتبط بإضاءة البشرة وتقليل التصبّغ — يعمل مع فيتامين C لأقصى فائدة.',
                          'NAC': 'N-أستيل سيستين، سلف الغلوتاثيون — يدعم مستوياته في الجسم ويساهم في مقاومة الأكسدة.',
                          'كركم': 'مستخلص نباتي ذو خصائص مضادة للالتهاب — يكمّل تركيبة البشرة من الداخل.',
                          'مايو-إينوسيتول': 'مادة طبيعية مرتبطة بتحسين حساسية الأنسولين ودعم التوازن الهرموني الأنثوي.',
                          'فيتكس': 'مستخلص توت العفاريت — عشبة تقليدية مرتبطة بتخفيف أعراض PMS وتوازن هرمونات الدورة.',
                          'فيتامين B6': 'يساعد في تنظيم الهرمونات وتقليل تقلبات المزاج المرتبطة بالدورة الشهرية.',
                          'كالسيوم': 'معدن أساسي لصحة العظام والعضلات — يكمّل منظومة دعم صحة المرأة مع D3 والمغنيسيوم.',
                          'زنجبيل': 'مستخلص نباتي معروف بخصائص مضادة للالتهاب وتخفيف تقلصات البطن.',
