                ...
                {product.ingredients.map((ing) => (
                  ...
                  >
                    ...
                    <p className="mt-2 border-t border-border/80 pt-2 text-sm leading-relaxed text-muted">
                      {ing === 'بيوتين' &&
                        'فيتامين B يدعم صحة الشعر والأظافر والبشرة ضمن مكمّل غذائي Hair · Skin · Nails — حسب الفورمولا على الغلاف.'}
                      {ing === 'زنك' &&
                        'معدن يدعم وظائف طبيعية مرتبطة بالشعر والبشرة والأظافر ضمن روتين تغذية داخلية منتظم.'}
                      {ing === 'فيتامين D' &&
                        'يدعم الصحة العامة وامتصاص الكالسيوم؛ ضمن الفورمولا مع البيوتين والزنك حسب غلاف عبوّتكم.'}
