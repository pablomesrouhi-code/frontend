...
export const PDP_ADD_CTA: Record<string, string> = {
  ...
  naseej: 'ابدئي روتين الجمال من الداخل الآن',
}
...
export const PDP_ROUTINE_NOTE: Record<string, { titleAr: string; bodyAr: string }> = {
  ...
  naseej: {
    titleAr: 'يومياً — مكيال كولاجين للتجاعيد والشعر والبشرة والأظافر',
    bodyAr:
      'صباحاً أو مع وجبة: مكيال واحد في ماء أو عصير فاتر حسب الغلاف. روتين جمال من الداخل بأربعة محاور. العروض والسعر واضحين قبل التأكيد.',
  },
}
