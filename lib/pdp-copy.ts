...
export const PDP_ADD_CTA: Record<string, string> = {
  ...
  naseej: 'ابدئي روتين قوام الوجه الآن',
...
export const PDP_ROUTINE_NOTE: Record<string, { titleAr: string; bodyAr: string }> = {
  ...
  naseej: {
    titleAr: 'يومياً — مكيال كولاجين لقوام الوجه من الداخل',
    bodyAr:
      'صباحاً أو مع وجبة: مكيال واحد في ماء أو عصير فاتر حسب الغلاف. زاوية قوام وشدّة — مختلفة عن علكة رونق C. العروض والسعر واضحين قبل التأكيد.',
  },
  vitaflow: {
