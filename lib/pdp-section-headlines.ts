...
export const PDP_SECTION_HEADLINES: Record<string, PdpSectionHeadlines> = {
  'rawnaq-c': {
    pain: {
      eyebrowAr: 'شعر خفيف، أظافر تتكسر، بشرة تعبانة؟',
      titleAr: 'مو كل ما تحتاجينه كريمات — أحيانًا الأساس من جوّا',
      subtitleAr:
        'رونق C يثبت علكتين صباحًا: بيوتين، زنك، D3 — روتين واحد بدل رفّ كامل ما يثبت.',
    ...
    ingredients: {
      ...
      titleAr: 'بيوتين · زنك · D3 — دعم الشعر والأظافر والبشرة من الداخل',
