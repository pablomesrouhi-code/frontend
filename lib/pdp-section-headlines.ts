...
export const PDP_SECTION_HEADLINES: Record<string, PdpSectionHeadlines> = {
  ...
  naseej: {
    pain: {
      eyebrowAr: 'وجه مرتخي… مكياج ما يثبت؟',
      titleAr: 'المشكل مو سيروم غالي — النسيج اللي يمسك وجهك ضعف',
      subtitleAr:
        'نسيج: كولاجين متعدد + هيالورونيك + فيتامين C + بيوتين. مكيال يومي لزاوية القوام — مو نفس زاوية علكة رونق C.',
      feelTitleAr: 'تعرفين هذا الإحساس؟',
      whyTitleAr: 'ليش يثبتن على مكيال كولاجين يومياً؟',
      desireTitleAr: 'وش يقدر يرجّع إحساس الشدّة — بلا ادّعاء عيادة؟',
    },
    ingredients: {
      eyebrowAr: 'تركيبة واضحة',
    ...
    routine: { titleAr: 'مكيال واحد في الماء — روتين قوام يثبت' },
    faq: {
    ...
    reviews: {
      eyebrowAr: 'تجارب حقيقية',
      titleAr: 'عميلات حسّن بفرق القوام — روتين، مو وعود سحرية',
      subtitleAr: 'آراء شخصية؛ النتيجة تعتمد على الالتزام والجسم.',
    },
    closingOffer: {
      eyebrowAr: 'جاهزة؟',
