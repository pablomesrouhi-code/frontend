...
export const PDP_SECTION_HEADLINES: Record<string, PdpSectionHeadlines> = {
  ...
  'shahr-hadi': {
    pain: {
      eyebrowAr: 'هذا الإحساس تعرفينه',
      titleAr: 'يومك ما عاد يوقف كل دورة',
      subtitleAr: 'مكيال يومي يدعمك من الداخل. والعبوة أقل من قهوة في اليوم.',
      feelTitleAr: 'تعرفين هذا الإحساس؟',
      whyTitleAr: 'ليش تبدأين قبل ما يجي الشهر؟',
      desireTitleAr: 'كيف يتحوّل يومك؟',
    },
    ingredients: {
      eyebrowAr: 'التركيبة',
      titleAr: 'أربع مكوّنات. روتين واحد.',
      subtitleAr: 'مايو-إينوسيتول · فيتكس · مغنيسيوم · B6 — التفاصيل على الغلاف.',
    },
    routine: { titleAr: 'دقيقة. كل يوم. شهر أهدأ.' },
    faq: {
      eyebrowAr: 'قبل الطلب',
      titleAr: 'الثمن. الدفع. ومتى يبان الفرق.',
      subtitleAr: '199 للشهر · كاش عند الباب.',
    },
    reviews: {
      titleAr: 'بدأن روتين… وعاشوا الشهر مختلف',
    },
    closingOffer: {
      eyebrowAr: 'جاهزة؟',
      titleAr: 'الشهر الجاي يبدأ من هالطلب',
    },
  },
  naseej: {
    pain: {
      eyebrowAr: 'فرشاة مليانة… وشعر يتكسّر؟',
      titleAr: 'المشكل مو شامبو غالي — الكولاجين من الداخل',
      subtitleAr:
        'نسيج: كولاجين متعدد + هيالورونيك + فيتامين C + بيوتين. مكيال يومي — الشعر أولاً، ثم التجاعيد والبشرة.',
      feelTitleAr: 'تعرفين هذا الإحساس؟',
      whyTitleAr: 'ليش يثبتن على مكيال كولاجين يومياً؟',
      desireTitleAr: 'وش يقدر يثبّت روتين الشعر — بلا وعود سحرية؟',
    },
    ingredients: {
      eyebrowAr: 'تركيبة واضحة',
    ...
    routine: { titleAr: 'مكيال واحد في الماء — روتين شعر يثبت' },
    faq: {
      eyebrowAr: 'جايّة من إعلان «نسيج»؟',
      titleAr: 'كل الإجابات قبل الطلب — بدون لفّ',
      subtitleAr: 'شعر أولاً · فرق عن رونق C · دفع عند الباب.',
    },
    reviews: {
      eyebrowAr: 'تجارب حقيقية',
      titleAr: 'عميلات حسّن بفرق الشعر — روتين، مو وعود سحرية',
      subtitleAr: 'آراء شخصية؛ النتيجة تعتمد على الالتزام والجسم.',
    },
    closingOffer: {
      eyebrowAr: 'جاهزة؟',
      titleAr: 'اختاري عرض نسيج واطلبي — من 189 ر.س',
    },
  },
  vitaflow: {
    pain: {
      eyebrowAr: 'تصحّين والتعب يمسك يومك؟',
      titleAr: 'مو قهوة زيادة — روتين طاقة يثبت مع الجهد',
      subtitleAr:
        'فيتا فلو مسحوق كراميل: مكيال يومي لدعم الطاقة والجهد ضمن يوم طويل — بلا ادّعاء سحر.',
      feelTitleAr: 'تعرفين هذا الإحساس؟',
      whyTitleAr: 'ليش يختارونه لطاقة اليوم؟',
      desireTitleAr: 'وش يقدر يكمّل جهدك — واقعياً؟',
    },
    ingredients: {
      eyebrowAr: 'تركيبة واضحة',
      titleAr: 'مسحوق كراميل لدعم الطاقة اليومية',
      subtitleAr: 'ملخص تسويقي؛ الجرعة والقائمة الكاملة على الغلاف المعتمد.',
    },
    routine: { titleAr: 'مكيال واحد في الماء أو القهوة — روتين طاقة يثبت' },
    faq: {
      eyebrowAr: 'جايّة من إعلان «فيتا فلو»؟',
      titleAr: 'كل الإجابات قبل الطلب — بدون لفّ',
      subtitleAr: 'زاوية طاقة وجهد · دفع عند الباب · تأكيد هاتفي.',
    },
    reviews: {
      eyebrowAr: 'تجارب حقيقية',
      titleAr: 'عميلات حسّن بفرق الجهد — روتين، مو وعود سحرية',
      subtitleAr: 'آراء شخصية؛ النتيجة تعتمد على الالتزام والجسم.',
    },
    closingOffer: {
      eyebrowAr: 'جاهزة؟',
      titleAr: 'اختاري عرض فيتا فلو واطلبي — نفس الأسعار اللي شفتيها',
    },
  },
}
