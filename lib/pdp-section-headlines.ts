...
export const PDP_SECTION_HEADLINES: Record<string, PdpSectionHeadlines> = {
  ...
  naseej: {
    pain: {
      eyebrowAr: 'وجه مرتخي… فونديشن ما يثبت؟',
      titleAr: 'المشكل مو سيروم غالي — الكولاجين اللي يمسك الوجه ضعف',
      subtitleAr:
        'نسيج: كولاجين متعدد الأنواع + هيالورونيك + فيتامين C + بيوتين. مكيال يومي لزاوية القوام — مو نفس زاوية علكة رونق C.',
      feelTitleAr: 'تعرفين هذا الإحساس؟',
      whyTitleAr: 'ليش يثبتون على مكيال كولاجين يومياً؟',
      desireTitleAr: 'وش يقدر يرجّع إحساس القوام — بلا ادّعاء عيادة؟',
    },
    ingredients: {
      eyebrowAr: 'تركيبة واضحة',
    ...
    faq: {
      ...
      titleAr: 'كل الإجابات قبل ما تطلبي — بدون لفّ',
      subtitleAr: 'فرق واضح عن رونق C · دفع عند الباب · تأكيد هاتفي.',
    },
    reviews: {
      eyebrowAr: 'تجارب حقيقية',
      titleAr: 'عميلات حسّن بفرق القوام — كلام روتين، مو وعود سحرية',
      subtitleAr: 'آراء شخصية؛ النتيجة تعتمد على الالتزام والجسم.',
    },
    closingOffer: {
      eyebrowAr: 'جاهزة؟',
